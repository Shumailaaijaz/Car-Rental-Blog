  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen mt-5">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <ul className="list-disc list-inside text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
          <li className="mb-2">
            <strong>Customer First:</strong> We put our customers at the heart of everything we do, ensuring they have a positive and hassle-free rental experience.
          </li>
          <li className="mb-2">
            <strong>Quality and Safety:</strong> Our fleet of vehicles is regularly serviced and maintained to the highest standards to guarantee safety and reliability.
          </li>
          <li className="mb-2">
            <strong>Innovation:</strong> We embrace technology to streamline our operations and provide a modern, efficient service.
          </li>
          <li>
            <strong>Sustainability:</strong> We are committed to environmentally responsible practices and offer eco-friendly vehicle options.
          </li>
        </ul>
