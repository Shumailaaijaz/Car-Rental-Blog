...
const fetchdata = await fetch(`https://freetestapi.com/api/v1/cars/${params.product}`);
  ...
  return (
    ...
    <section className="text-gray-600 body-font overflow-hidden">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest font-bold text-pretty">
          Best RentalCar Options
        </h2>
        ...
        <p className="leading-relaxed">
          Features: Autopilot, Premium Interior, Panoramic Roof, leather Seats, Navigation System 
          <br />
          Mileage: 80000
        </p>
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">
            Rent a Car
          </button>
